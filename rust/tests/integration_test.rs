...
use compression_prompt::{Compressor, CompressorConfig, StatisticalFilter, StatisticalFilterConfig};
...
fn test_compression_quality_metrics() {
    ...
    assert!(compression_achieved >= 0.2, "Expected at least 20% compression, got {:.1}%", compression_achieved * 100.0);
